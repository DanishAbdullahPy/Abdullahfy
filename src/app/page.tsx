  ...
  return (
    <>
      <main>
            ...
            <ContainerScroll
              titleComponent={
                <div className="flex items-center flex-col">
                  ...
                  <h1 className=" mb-6 text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                    Automate Your Work With Abdullahfy
                  </h1>
                </div>
              }
            />
        ...
        <div className="h-28 md:h-40 lg:h-60 w-full"></div>

        <div className="relative w-full overflow-hidden z-20">
          <InfiniteMovingCards
            className="w-full mt-10 md:mt-5 mb-12"
            items={clients}
            direction="right"
            speed="slow"
          />
